...
#define TEXTURE_COUNT 48u
#define GRID_COLUMNS  8u

#define PANEL_X_START 25u
#define PANEL_Y_START 25u
#define PANEL_WIDTH   220u
#define PANEL_HEIGHT  160u
#define PANEL_X_STEP  235u
#define PANEL_Y_STEP  175u
...
int main(void) {
	...
	printf("\n=== 48 TEXTURE GRID TEST ===\n");
	printf("8 columns x 6 rows, one panel per texture\n");
	printf("48 quads, 96 triangles, 32 texels in parallel\n");
	printf("Texture IDs increase left-to-right, then top-to-bottom\n");
	printf("Texture 0 is brick; textures 1-47 use generated data\n");
